...
# Manual placement TCL: ICache->top-right, DCache->left walls, 540um center corridor
...
# SETUP_SLACK_MARGIN: tighter for final run - resizer keeps optimizing until slack > -0.05ns
...
export MAX_REPAIR_TIMING_ITER = 30
# Increase setup margin further for final run
export SETUP_SLACK_MARGIN = -0.05
